...
public class StartMenu implements ActionListener {
	...
	private void AddGui() {
		Game.gui.add(New);
		Game.gui.add(Load);
		//Game.edu.ufp.inf.sd.rmi.project.client.jogo.edu.ufp.inf.sd.rabbitmqservices.projeto.jogo.edu.ufp.inf.sd.rabbitmqservices.projeto.jogo.buildings.edu.ufp.inf.sd.rabbitmqservices.projeto.jogo.gui.add(Join);
		Game.gui.add(Editor);
