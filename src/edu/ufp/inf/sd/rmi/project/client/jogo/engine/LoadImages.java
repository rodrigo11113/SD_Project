...
public class LoadImages {
	...
	public LoadImages() {
		...
		Game.img_char = tool.getImage(getClass().getResource("/edu/ufp/inf/sd/rmi/project/client/jogo/img/" +"Units"+".png"));
		Game.img_tile = tool.getImage(getClass().getResource("/edu/ufp/inf/sd/rmi/project/client/jogo/img/" +"Terrain"+".png"));
		Game.img_city = tool.getImage(getClass().getResource("/edu/ufp/inf/sd/rmi/project/client/jogo/img/" +"Cities"+".png"));
		Game.img_exts = tool.getImage(getClass().getResource("/edu/ufp/inf/sd/rmi/project/client/jogo/img/" +"Extras"+".png"));
		Game.img_plys = tool.getImage(getClass().getResource("/edu/ufp/inf/sd/rmi/project/client/jogo/img/" +"Players"+".png"));
		Game.img_menu[0] = tool.getImage(getClass().getResource("/edu/ufp/inf/sd/rmi/project/client/jogo/img/" +"GameInfo"+".png"));
	}
	...
	private Image OldImage(String type) {
		return Toolkit.getDefaultToolkit().getImage(getClass().getResource("/edu/ufp/inf/sd/rmi/project/client/jogo/img/" + type + ".png"));
	}
}
