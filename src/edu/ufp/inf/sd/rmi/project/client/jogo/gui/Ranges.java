package edu.ufp.inf.sd.rmi.project.client.jogo.gui;

import java.awt.Color;
import java.awt.Graphics2D;
import java.awt.Point;

import edu.ufp.inf.sd.rmi.project.client.jogo.units.Base;
import edu.ufp.inf.sd.rmi.project.client.jogo.engine.Game;
import edu.ufp.inf.sd.rmi.project.client.jogo.engine.Pathfinding;

/**
 * Depending on if a unit is selected by the current player and the edu.ufp.inf.sd.rmi.project.client.jogo.edu.ufp.inf.sd.rabbitmqservices.projeto.jogo.edu.ufp.inf.sd.rabbitmqservices.projeto.jogo.buildings.edu.ufp.inf.sd.rabbitmqservices.projeto.jogo.units state, it will draw the movement range (based on path finding outcome).
 ...
 * It will also draw the attackable locations depending on the edu.ufp.inf.sd.rmi.project.client.jogo.edu.ufp.inf.sd.rabbitmqservices.projeto.jogo.edu.ufp.inf.sd.rabbitmqservices.projeto.jogo.buildings.edu.ufp.inf.sd.rabbitmqservices.projeto.jogo.units max and min attack ranges.
 * @author SergeDavid
 * @version 0.3
 */
public class Ranges {
	public static void Draw(Graphics2D gg, int resize) {
		if (Game.player.get(Game.btl.currentplayer).unitselected) {
			...
			edu.ufp.inf.sd.rmi.project.client.jogo.units.Base unit = Game.units.get(Game.player.get(Game.btl.currentplayer).selectedunit);
	...
	private static void Moving(Graphics2D gg, edu.ufp.inf.sd.rmi.project.client.jogo.units.Base unit, int size, int resize) {
