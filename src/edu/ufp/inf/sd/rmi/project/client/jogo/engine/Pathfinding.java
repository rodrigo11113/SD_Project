...
public class Pathfinding {
	...
	private edu.ufp.inf.sd.rmi.project.client.jogo.units.Base unit;
	...
	public Vector<Point> FindPath(edu.ufp.inf.sd.rmi.project.client.jogo.units.Base unit, int range) {
