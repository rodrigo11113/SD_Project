...
public class Game extends JFrame {
	...
	public static List<edu.ufp.inf.sd.rmi.project.client.jogo.units.Base> units = new ArrayList<edu.ufp.inf.sd.rmi.project.client.jogo.units.Base>();
	...
	public Game() {super (name);
		...
		//Creates all the edu.ufp.inf.sd.rmi.project.client.jogo.edu.ufp.inf.sd.rabbitmqservices.projeto.jogo.edu.ufp.inf.sd.rabbitmqservices.projeto.jogo.buildings.edu.ufp.inf.sd.rabbitmqservices.projeto.jogo.gui elements and sets them up
		gui = new Gui(this);
		add(gui);
