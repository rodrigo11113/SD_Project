 ...
 * Place MoveView(); in the game-loop (100ms) to automate it (Teleporting across the map between switching viewed edu.ufp.inf.sd.rmi.project.client.jogo.edu.ufp.inf.sd.rabbitmqservices.projeto.jogo.edu.ufp.inf.sd.rabbitmqservices.projeto.jogo.buildings.edu.ufp.inf.sd.rabbitmqservices.projeto.jogo.units / turns is automatic)
