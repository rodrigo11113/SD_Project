...
public class ComputerBrain {
	...
	public void ThinkDamnYou(edu.ufp.inf.sd.rmi.project.client.jogo.players.Base ply) {
		...
		if (!DoneUnits) {
			edu.ufp.inf.sd.rmi.project.client.jogo.units.Base unit = Game.units.get(UnitCount);
			UnitCount++;
			...
			edu.ufp.inf.sd.rmi.project.client.jogo.buildings.Base bld = Game.builds.get(CityCount);
			CityCount++;
	...
	private void HandleBuilding(edu.ufp.inf.sd.rmi.project.client.jogo.buildings.Base bld) {
		if (!bld.Menu.equals("")) {
			if (!bld.Locked) {
	...
	/**Looks for any enemies in range at the edu.ufp.inf.sd.rmi.project.client.jogo.edu.ufp.inf.sd.rabbitmqservices.projeto.jogo.edu.ufp.inf.sd.rabbitmqservices.projeto.jogo.buildings.edu.ufp.inf.sd.rabbitmqservices.projeto.jogo.units current location by attacking each location in the attackable locations.*/
	private boolean WannaHug(edu.ufp.inf.sd.rmi.project.client.jogo.units.Base unit) {
	...
	private boolean BuildingInRange(edu.ufp.inf.sd.rmi.project.client.jogo.units.Base unit) {
