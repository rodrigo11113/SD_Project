package edu.ufp.inf.sd.rmi.project.client.jogo.players;
...
public class Base {
	...
	public int usedunits;//How many edu.ufp.inf.sd.rmi.project.client.jogo.edu.ufp.inf.sd.rabbitmqservices.projeto.jogo.edu.ufp.inf.sd.rabbitmqservices.projeto.jogo.buildings.edu.ufp.inf.sd.rabbitmqservices.projeto.jogo.units does the player have left until turn ends. Currently unused.
	public int kills;
	public int loses;
	...
	/**The first special ability the player can use when the edu.ufp.inf.sd.rmi.project.client.jogo.edu.ufp.inf.sd.rabbitmqservices.projeto.jogo.edu.ufp.inf.sd.rabbitmqservices.projeto.jogo.buildings.edu.ufp.inf.sd.rabbitmqservices.projeto.jogo.players power>level1. leave level1 at 0 to remove access to this ability.*/
