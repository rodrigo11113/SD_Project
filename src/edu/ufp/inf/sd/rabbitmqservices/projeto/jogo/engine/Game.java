...
public class Game extends JFrame {
	...
	public static List<edu.ufp.inf.sd.rabbitmqservices.projeto.jogo.units.Base> units = new ArrayList<edu.ufp.inf.sd.rabbitmqservices.projeto.jogo.units.Base>();
	//These are the lists that will hold commander, building, and unit data to use in the menu's
	public static List<edu.ufp.inf.sd.rabbitmqservices.projeto.jogo.players.Base> displayC = new ArrayList<edu.ufp.inf.sd.rabbitmqservices.projeto.jogo.players.Base>();
	...
	public Game(String mapa,Observer observer1) {super (name);
		...
		//Creates all the edu.ufp.inf.sd.rabbitmqservices.projeto.jogo.gui elements and sets them up
		gui = new Gui(this);
		add(gui);
