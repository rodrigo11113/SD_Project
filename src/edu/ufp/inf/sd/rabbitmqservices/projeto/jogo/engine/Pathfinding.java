...
public class Pathfinding {
	...
	private edu.ufp.inf.sd.rabbitmqservices.projeto.jogo.units.Base unit;
	...
	public Vector<Point> FindPath(edu.ufp.inf.sd.rabbitmqservices.projeto.jogo.units.Base unit, int range) {
