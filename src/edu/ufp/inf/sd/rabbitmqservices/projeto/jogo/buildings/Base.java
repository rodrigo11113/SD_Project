...
public class Base {
	...
	public Base(int owner,int xx, int yy) {
		//15 = Neutral, 12~14 are unused. (12 max edu.ufp.inf.sd.rabbitmqservices.projeto.jogo.players)
	...
	public void OpenMenu() {
		if (Menu!=null) {
			new edu.ufp.inf.sd.rabbitmqservices.projeto.jogo.menus.City(Menu, x, y);
		}
	}
