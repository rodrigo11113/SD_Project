...
public class Gui extends JPanel {
	...
	public void paintComponent(Graphics g) {
		...
		case PLAYING:
			...
			edu.ufp.inf.sd.rabbitmqservices.projeto.jogo.gui.Terrain.Draw(gg, Game.ScreenBase);
			edu.ufp.inf.sd.rabbitmqservices.projeto.jogo.gui.Ranges.Draw(gg, Game.ScreenBase);
			edu.ufp.inf.sd.rabbitmqservices.projeto.jogo.gui.Cities.Draw(gg, Game.ScreenBase);
			edu.ufp.inf.sd.rabbitmqservices.projeto.jogo.gui.Units.Draw(gg, Game.ScreenBase);
			edu.ufp.inf.sd.rabbitmqservices.projeto.jogo.gui.Selector.Draw(frame, gg, Game.ScreenBase,
					Game.player.get(Game.btl.currentplayer).selectx,
					Game.player.get(Game.btl.currentplayer).selecty);
			edu.ufp.inf.sd.rabbitmqservices.projeto.jogo.gui.SmallMenu.Draw(gg,frame);
		break;
		case EDITOR:
			gg.setColor(new Color(0,0,60));
			gg.fillRect(0, 0, width, height);
